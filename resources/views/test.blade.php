  ...
  <body class="index-page">
    <header id="header" class="header d-flex align-items-center fixed-top">
      ...
      >
        <a href="index.html" class="logo d-flex align-items-center me-auto">
          <img src="{{ asset('assets/Dewi-1.0.0/assets/img/upj_png_latar_putih.png') }}" alt="" />
        </a>
        ...
        <a class="cta-btn" href="indexupj.html">Dashboard</a>
      </div>
    </header>
    ...
    <main class="main">
      ...
      <section id="hero" class="hero section dark-background">
        <img src="{{ asset('assets/Dewi-1.0.0/assets/img/produk tpm - Copy/bb.jpg') }}" alt="" data-aos="fade-in" />

        <div class="container d-flex flex-column align-items-center">
          <h2 data-aos="fade-up" data-aos-delay="100">UPJ SMK NEGERI 2 BANGKALAN</h2>
          <p data-aos="fade-up" data-aos-delay="200">
            Unit Produksi & Jasa
          </p>
          <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
            <a href="#about" class="btn-get-started">Markimu(mari kita mulai:v)</a>
            <a
              href="https://www.youtube.com/watch?v=Y7f98aduVJ8"
              class="glightbox btn-watch-video d-flex align-items-center"
              ><i class="bi bi-play-circle"></i><span> UPJ</span></a
            >
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row gy-4">
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              <img
                src="{{ asset('assets/Dewi-1.0.0/assets/img/produk tpm - Copy/dot.jpg') }}"
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
              <div class="content ps-0 ps-lg-5">
                ...
                <div class="position-relative mt-4">
                  <img
                    src="{{ asset('assets/Dewi-1.0.0/assets/img/produk tpm - Copy/terbang.jpg') }}"
                    class="img-fluid rounded-4"
                    alt=""
                  />
                  <a
                    href="https://youtu.be/2U58FsTwepo?si=B9_25qJ7FVGd4nX3"
        ...
        <div class="row gy-5">
            ...
            <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                <div class="service-item">
                    <div class="img">
                        <img src="{{ asset('storage/products' . $item->img) }}" class="img-fluid" alt="{{ $item->name }}" />
                    </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item">
                <div class="portfolio-content h-100">
                    ...
                    <div class="portfolio-info">
                        ...
                        <a href="https://wa.me/{{ $service->no_whatsapp }}?text={{ urlencode($service->pesan_whatsapp) }}" 
                           target="_blank" 
                           class="details-link">
...
<!-- Footer start -->
    ...
    <footer id="footer" class="footer dark-background">
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            ...
            <div class="footer-contact pt-3">
              <p>Jl. Halim Perdana Kusuma (Ring Road) Bangkalan</p>
              <p>Madura Jawa Timur</p>
              <p class="mt-3">
                <strong>Phone:</strong> <span>+62 851799000</span>
              </p>
              <p><strong>Email:</strong> <span>sementara@gmail.com</span></p>
            </div>
      ...
      <div class="container copyright text-center mt-4">
        <p>
          © <span>Copyright</span> <strong class="px-1 sitename">SMK NEGERI 2 BANGKALAN</strong>
