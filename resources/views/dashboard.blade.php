      ...
      <div class="layout-container">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="layouts-blank.html" class="menu-link">
                    <div data-i18n="Blank">Galeri</div>
                  </a>
                </li>
              </ul>
            </li>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-8">
                        <div class="card-body">
                          ...
                          <a href="javascript:;" class="btn btn-sm btn-outline-primary">SMKN 2 BANGKALAN</a>
                        </div>
                      </div>
            ...
            <!-- Footer -->
            <footer class="content-footer footer bg-footer-theme shadow-lg">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  Unit Pelayanan Jasa
                  <a href="https://smkn2-bangkalan.sch.id/" target="_blank" class="footer-link fw-bolder ms-2">SMKN 02 BANGKALAN</a>
                </div>
                {{-- <div>
